...
- file: .env.example
  ...
  critical: Each provider needs API_KEY, BASE_URL, and MODEL variables
...
Task 2: Create Layer Implementation
...
Task 6: Export from Index Files
...
// Task 2: Layer Implementation (key parts)
...
// Task 5: Integration Test pattern
